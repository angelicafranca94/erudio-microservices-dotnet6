...
public class DbInitializer : IDbInitializer
{
    ...
    public void Initialize()
    {
        ...
        {
            UserName = "angelica-admin",
            Email = "angelica-angelica@gmail.com",
            EmailConfirmed = true,
            PhoneNumber = "55 (11) 12345-2345",
            FirstName = "Angélica",
            LastName = "Admin"

        };

        _user.CreateAsync(admin, "Angelica123$").GetAwaiter().GetResult();
        ...
        _user.CreateAsync(client, "Angelica123$").GetAwaiter().GetResult();
